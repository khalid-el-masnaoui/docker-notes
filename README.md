...
When it comes to storing persistent docker container data , we have two option **Volumes** and **Bind Mounts**.
...
$ docker volume inspect NAME  #Shows some information like the mount-point
